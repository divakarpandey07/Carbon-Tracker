...
const FootprintTrendChart = () => {
  ...
  if (trend.length === 0) {
    return (
      <div className="rounded-3xl bg-slate-900/40 backdrop-blur-xl border border-white/10 p-8 text-center text-slate-400 flex flex-col items-center justify-center h-full">
      ...
      <div>
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <h2 className="text-2xl font-black text-white tracking-tight">Emissions Trend</h2>
          </div>
          <span className="text-xs font-semibold bg-slate-950/80 border border-slate-700 text-slate-300 px-3.5 py-1.5 rounded-full">
            Last 6 Months
          </span>
        </div>
